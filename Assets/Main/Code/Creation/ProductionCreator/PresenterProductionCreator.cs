...
public class PresenterProductionCreator : MonoBehaviour
{
    ...
    private PresenterProduction _presenterProduction;
    ...
    public void Initialize(EventBus eventBus)
    {
        ...
        _presenterProduction = Create();
    }

    public PresenterProduction GetPresenterProduction()
    {
        return _presenterProduction;
    }
    ...
    private PresenterProduction Create()
    {
