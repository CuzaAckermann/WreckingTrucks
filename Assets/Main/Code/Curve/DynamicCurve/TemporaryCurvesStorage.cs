...
public class TemporaryCurvesStorage
{
    ...
    public TemporaryCurvesStorage(BezierCurveSettings bezierCurveSettings,
                                  BezierNode endPoint)
    {
    ...
    public void CalculateCurves(IReadOnlyList<Model> models)
    {
        ...
        for (int i = 0; i < models.Count; i++)
        {
            ...
            _temporaryCurves[i] = CreateModelBezierCurve(model.Placeable.Position, model.Placeable.Forward);
        }
